...
export default function Profile() {
  ...
  const getEductionData = async () => {
    try {
      const response = await axiosInstance.get(`/api/users/education`);
  ...
  async function handleDelete (educationId) {
        ...
        try{
      const response = await axiosInstance.delete(`/api/users/education/${educationId}`);
    ...
    <>
      ...
      <div className="flex flex-col gap-5">
        ...
        <div className="bg-white shadow-md rounded-2xl border border-gray-200 ">
          ...
          <div className="pl-6 pr-6 pb-6">
            <img
              ...
              alt="User profile"
              className="w-30 h-30 rounded-full -mt-15  border border-white border-4"
            />
        ...
        <div className="grid grid-cols-3 gap-4 ">
          ...
          <div className="flex items-center justify-start gap-3 bg-white border border-gray-200 rounded-2xl px-7 py-3 shadow-sm">
            <div className="w-10 h-10 bg-blue-100 rounded-2xl flex justify-center items-center">
              <MdOutlineArticle className="text-blue-600 text-xl" />
            </div>
            <div className="">
          ...
          <div className="flex items-center justify-start gap-3 bg-white border border-gray-200 rounded-2xl px-7 py-3 shadow-sm">
            <div className="w-10 h-10 bg-blue-100 rounded-2xl flex justify-center items-center">
              <MdOutlineRemoveRedEye className="text-blue-600 text-xl" />
            </div>
            <div className="">
        ...
        <div className="p-6 bg-white shadow-sm border border-gray-200 rounded-2xl">
          <div className="flex justify-between">
            ...
            <button className="hover:bg-emerald-400 p-2 rounded-xl">
              <LuPencil className="text-gray-600" />
            </button>
          </div>
          <p className="text-gray-800 mt-4 text-left text-sm leading-6">
            Product designer with 8+ years of experience shaping clean,
            accessible interfaces for SaaS and fintech teams. I care about
            systems, craft, and shipping.
          </p>
        </div>
        ...
        <div className="p-6 bg-white shadow-sm border border-gray-200 rounded-2xl">
          ...
          <div className="flex justify-start gap-2 mt-3">
            <div className="inline-block flex justify-center items-center bg-blue-100 rounded-2xl hover:bg-blue-50 px-2 py-1">
              <p className="text-blue-600">React</p>
            </div>
            <div className="inline-block flex justify-center items-center bg-blue-100 rounded-2xl hover:bg-blue-50  px-2 py-1">
              <p className="text-blue-600">Node.js</p>
            </div>
            <div className="inline-block flex justify-center items-center bg-blue-100 rounded-2xl hover:bg-blue-50  px-2 py-1">
              <p className="text-blue-600">UI/UX Design</p>
            </div>
            <div className="inline-block flex justify-center items-center bg-blue-100 rounded-2xl hover:bg-blue-50  px-2 py-1">
              <p className="text-blue-600">Project Management</p>
            </div>
            <div className="inline-block flex justify-center items-center bg-blue-100 rounded-2xl hover:bg-blue-50  px-2 py-1">
              <p className="text-blue-600">Typescript</p>
            </div>
          </div>
        </div>
            ...
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-gray-700 text-sm">
                  Lead design on the issue tracking surface and design system.
                </p>
              </div>
            </div>
        ...
        <div className="p-6 bg-white shadow-sm border border-gray-200 rounded-2xl">
          <div className="flex justify-between">
            ...
            <div className="flex justify-between items-center gap-4">
               <button
              className="hover:bg-emerald-400 p-2 rounded-xl "
              onClick={() => {
                setOpen(true);
              }}
            >   
          ...
          {educationData?.map((education) => {
            const educationId = education._id; // Assuming each education entry has a unique 'id' property
            return (
              <>
                <div className="flex flex-col gap-6 mt-4">
                  <div className="flex justify-between">
                    ...
                    <button className="hover:bg-emerald-400 p-2 rounded-xl " onClick={
                       () => handleDelete(educationId) }  disabled={deleteLoading === education._id}
                    > 
                     {deleteLoading === education._id ? 
                       (<span className="animate-spin"><LuLoaderCircle/></span>):
                      (<MdDeleteForever className="text-gray-800 h-6 w-6" />)
                     }
                    </button>
                    </div>
                  </div>
